        ...
        <div className="flex flex-col w-[300px] h-[450px] p-[20px] rounded-[20px] bg-[#0c0b0b]">
            ...
            <form onSubmit={addPassword} className="flex flex-col justify-evenly h-[100%]">
                <div>
                    ...
                    <input className="block w-[80%] h-[30px] p-[5px] rounded-[8px] border-2 border-[#414141] text-[#414141] text-[15px] duration-200 focus:scale-107"
                        type="text" 
                        placeholder="service" 
                        required
                        value={service}
                ...
                <div>
                    ...
                    <input
                        className="block w-[80%] h-[30px] p-[5px] rounded-[8px] border-2 border-[#414141] text-[#414141] text-[15px] duration-200 focus:scale-107" 
                        type="text" 
